...
namespace ASP_NET_CORE_SHOP.Controllers
{
        ...
        //По двом інтерфейсам
    {
        ...
        public ViewResult CarsList()//Повертатиме результат а саме список всіх товарів             коли ми будемо обращатьсь до даної функції ми будемо отримувати HTML сторінку з всіми авто
        {
